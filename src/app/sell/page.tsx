...
function SellPage() {
    ...
    useEffect(() => {
        async function fetchInitialData() {
            ...
            try {
                ...
                setProviders(providersRes.filter(p => p.can_sell));
            } catch (err: any) {
    ...
    const handleSell = async () => {
        ...
        try {
            ...
            toast({ title: 'Sell Order Created', description: `Your order #${response.id} is being processed.` });
            ...
            {currentStep === 3 && (
                 <Card>
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); handleNext(); }}>
                        ...
                        <CardFooter>
                           <Button type="submit" className="w-full" size="lg">Review Sell Order</Button>
                        </CardFooter>
                    </form>
                    </Form>
                </Card>
            ...
            {currentStep === 4 && (
                <Card>
                    ...
                    <CardFooter className="flex flex-col gap-2">
                        <Button size="lg" className="w-full" disabled={isEstimatingFee || !feeEstimation || isSubmitting} onClick={handleSell}>
