...
const login = (credentials: any): Promise<AuthResponse> => publicAxiosInstance.post('auth/login/', credentials).then(res => res.data);
const register = (userInfo: any): Promise<AuthResponse> => publicAxiosInstance.post('auth/register/', userInfo).then(res => res.data);
